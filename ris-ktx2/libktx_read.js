var createKtxReadModule = (() => {
    ...
    return async function (moduleArg = {}) {
        ...
        function findWasmBinary() {
            return locateFile("libktx_read.wasm")
        }
        ...
        var webglPrepareUniformLocationsBeforeFirstUse = program => {
            var uniformLocsById = program.uniformLocsById, uniformSizeAndIdsByName = program.uniformSizeAndIdsByName, i,
                j;
            if (!uniformLocsById) {
        ...
        Module["GL"] = GL;
        var ___getTypeName, _free, _malloc;

        function assignWasmExports(wasmExports) {
            ___getTypeName = wasmExports["Xe"];
            _free = wasmExports["Ze"];
            _malloc = wasmExports["_e"]
        }
        ...
        var wasmImports = {
            ...
            Ae: __emval_new_object,
            f: __emval_run_destructors,
            u: __emval_set_property,
            Na: __tzset_js,
            ua: _emscripten_glActiveTexture,
            sa: _emscripten_glAttachShader,
            Rc: _emscripten_glBeginQuery,
            La: _emscripten_glBeginQueryEXT,
            tc: _emscripten_glBeginTransformFeedback,
            ra: _emscripten_glBindAttribLocation,
            qa: _emscripten_glBindBuffer,
            qc: _emscripten_glBindBufferBase,
            rc: _emscripten_glBindBufferRange,
            pa: _emscripten_glBindFramebuffer,
            oa: _emscripten_glBindRenderbuffer,
            wb: _emscripten_glBindSampler,
            na: _emscripten_glBindTexture,
            ob: _emscripten_glBindTransformFeedback,
            yc: _emscripten_glBindVertexArray,
            Ca: _emscripten_glBindVertexArrayOES,
            ma: _emscripten_glBlendColor,
            la: _emscripten_glBlendEquation,
            ka: _emscripten_glBlendEquationSeparate,
            ja: _emscripten_glBlendFunc,
            ha: _emscripten_glBlendFuncSeparate,
            Dc: _emscripten_glBlitFramebuffer,
            ...
            hd: _emscripten_glClipControlEXT,
            ...
            Xc: _emscripten_glCopyTexSubImage3D,
            ...
            nb: _emscripten_glDeleteTransformFeedbacks,
            xc: _emscripten_glDeleteVertexArrays,
            Ba: _emscripten_glDeleteVertexArraysOES,
            M: _emscripten_glDepthFunc,
            L: _emscripten_glDepthMask,
            K: _emscripten_glDepthRangef,
            J: _emscripten_glDetachShader,
            I: _emscripten_glDisable,
            H: _emscripten_glDisableVertexAttribArray,
            G: _emscripten_glDrawArrays,
            Lb: _emscripten_glDrawArraysInstanced,
            xa: _emscripten_glDrawArraysInstancedANGLE,
            Ya: _emscripten_glDrawArraysInstancedARB,
            ed: _emscripten_glDrawArraysInstancedEXT,
            Za: _emscripten_glDrawArraysInstancedNV,
            Kc: _emscripten_glDrawBuffers,
            cd: _emscripten_glDrawBuffersEXT,
            ya: _emscripten_glDrawBuffersWEBGL,
            F: _emscripten_glDrawElements,
            Kb: _emscripten_glDrawElementsInstanced,
            wa: _emscripten_glDrawElementsInstancedANGLE,
            Wa: _emscripten_glDrawElementsInstancedARB,
            Xa: _emscripten_glDrawElementsInstancedEXT,
            dd: _emscripten_glDrawElementsInstancedNV,
            ad: _emscripten_glDrawRangeElements,
            E: _emscripten_glEnable,
            D: _emscripten_glEnableVertexAttribArray,
            Qc: _emscripten_glEndQuery,
            Ka: _emscripten_glEndQueryEXT,
            sc: _emscripten_glEndTransformFeedback,
            Jb: _emscripten_glFenceSync,
            C: _emscripten_glFinish,
            B: _emscripten_glFlush,
            zc: _emscripten_glFlushMappedBufferRange,
            A: _emscripten_glFramebufferRenderbuffer,
            z: _emscripten_glFramebufferTexture2D,
            Bc: _emscripten_glFramebufferTextureLayer,
            y: _emscripten_glFrontFace,
            x: _emscripten_glGenBuffers,
            Ue: _emscripten_glGenFramebuffers,
            Uc: _emscripten_glGenQueries,
            cb: _emscripten_glGenQueriesEXT,
            Te: _emscripten_glGenRenderbuffers,
            zb: _emscripten_glGenSamplers,
            Se: _emscripten_glGenTextures,
            mb: _emscripten_glGenTransformFeedbacks,
            wc: _emscripten_glGenVertexArrays,
            Aa: _emscripten_glGenVertexArraysOES,
            w: _emscripten_glGenerateMipmap,
            ...
            Lc: _emscripten_glGetBufferPointerv,
            Le: _emscripten_glGetError,
            Ke: _emscripten_glGetFloatv,
            fc: _emscripten_glGetFragDataLocation,
            ...
            ib: _emscripten_glGetProgramBinary,
            Ge: _emscripten_glGetProgramInfoLog,
            He: _emscripten_glGetProgramiv,
            Fa: _emscripten_glGetQueryObjecti64vEXT,
            Ha: _emscripten_glGetQueryObjectivEXT,
            Da: _emscripten_glGetQueryObjectui64vEXT,
            Nc: _emscripten_glGetQueryObjectuiv,
            Ga: _emscripten_glGetQueryObjectuivEXT,
            Oc: _emscripten_glGetQueryiv,
            Ia: _emscripten_glGetQueryivEXT,
            Fe: _emscripten_glGetRenderbufferParameteriv,
            qb: _emscripten_glGetSamplerParameterfv,
            rb: _emscripten_glGetSamplerParameteriv,
            ...
            oc: _emscripten_glGetTransformFeedbackVarying,
            ...
            gc: _emscripten_glGetUniformuiv,
            mc: _emscripten_glGetVertexAttribIiv,
            lc: _emscripten_glGetVertexAttribIuiv,
            ...
            Ma: _emscripten_glIsQueryEXT,
            le: _emscripten_glIsRenderbuffer,
            xb: _emscripten_glIsSampler,
            ke: _emscripten_glIsShader,
            Ib: _emscripten_glIsSync,
            je: _emscripten_glIsTexture,
            lb: _emscripten_glIsTransformFeedback,
            vc: _emscripten_glIsVertexArray,
            za: _emscripten_glIsVertexArrayOES,
            ie: _emscripten_glLineWidth,
            he: _emscripten_glLinkProgram,
            Ac: _emscripten_glMapBufferRange,
            kb: _emscripten_glPauseTransformFeedback,
            ge: _emscripten_glPixelStorei,
            gd: _emscripten_glPolygonModeWEBGL,
            fe: _emscripten_glPolygonOffset,
            id: _emscripten_glPolygonOffsetClampEXT,
            hb: _emscripten_glProgramBinary,
            gb: _emscripten_glProgramParameteri,
            Ja: _emscripten_glQueryCounterEXT,
            ...
            Cc: _emscripten_glRenderbufferStorageMultisample,
            jb: _emscripten_glResumeTransformFeedback,
            ...
            db: _emscripten_glTexStorage2D,
            bb: _emscripten_glTexStorage3D,
            Od: _emscripten_glTexSubImage2D,
            Yc: _emscripten_glTexSubImage3D,
            ...
            bc: _emscripten_glUniform4ui,
            Yb: _emscripten_glUniform4uiv,
            Mb: _emscripten_glUniformBlockBinding,
...
if (typeof exports === "object" && typeof module === "object") {
    module.exports = createKtxReadModule;
    module.exports.default = createKtxReadModule
} else if (typeof define === "function" && define["amd"]) define([], () => createKtxReadModule);
// -*- tab-width: 4; -*-
